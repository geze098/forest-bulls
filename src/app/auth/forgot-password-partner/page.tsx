...
import { IconAlertCircle, IconMail, IconLock, IconCheck, IconArrowLeft, IconBuilding } from '@tabler/icons-react';
...
export default function ForgotPasswordPartnerPage() {
    ...
    try {
      ...
      if (error) {
        ...
        notifications.show({
          ...
          message: 'Check your business email for password reset instructions.',
          color: 'green',
    ...
    try {
      ...
      if (error) {
        ...
        notifications.show({
          ...
          message: 'Your partner account password has been successfully updated.',
          color: 'green',
          icon: <IconCheck size={16} />,
        });
          ...
          <Stack gap="lg">
            <div style={{ textAlign: 'center' }}>
              ...
              <Text c="dimmed" size="sm" ta="center">
                We've sent a password reset link to your business email address.
                Click the link in the email to reset your partner account password.
              </Text>
            </div>
        ...
        <Stack gap="lg">
          <div style={{ textAlign: 'center' }}>
            ...
            <Group justify="center" mb="xs">
              ...
              <Title order={2}>
                {isPasswordReset ? 'Set New Password' : 'Reset Partner Password'}
              </Title>
            </Group>
            <Text c="dimmed" size="sm" ta="center">
              {isPasswordReset 
                ? 'Enter your new password for your partner account'
          ...
          <Stack gap="sm">
            ...
            <Text c="dimmed" size="sm" ta="center">
              ...
              <Anchor size="sm" component={Link} href="/auth/register-partner">
                Register as partner
              </Anchor>
            </Text>
